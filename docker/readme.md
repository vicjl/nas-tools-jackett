...
services:
  nas-tools:
    image: mikutechnology/nas-tools-jackett:latest
    ports:
    ...
    environment: 
     ...
     #- REPO_URL=https://ghproxy.com/https://github.com/mikutechnology/nas-tools-jackett.git  # 当你访问github网络很差时，可以考虑解释本行注释
    restart: always
    network_mode: bridge
    hostname: nas-tools
